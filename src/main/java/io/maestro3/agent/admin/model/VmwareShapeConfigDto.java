...
public class VmwareShapeConfigDto {
    ...
    public VmwareShapeConfigDto() {
    }

    public VmwareShapeConfigDto(String name, double units, int cpuCount, int memory, int storageGb) {
        this.name = name;
        this.units = units;
    ...
    public VmwareShape toShape(){
        VmwareShape shape = new VmwareShape();
